...
function DepartmentsPage() {
  ...
  async function submit(e: React.FormEvent) {
    ...
    try {
      if (editing) {
        await updateDepartment({ ...editing, name: name.trim(), description: description.trim() });
  ...
  return (
    ...
    >
      ...
      <ConfirmDialog
        ...
        description="This department and all its employees will be permanently deleted. This action cannot be undone."
